...
# Установленный факт: print("new_event: ", new_event) > new_event: Регион:  Погода:
# Вывод: Гипотеза подтвердилась, в переменной new_event отсутствуют данные, необходим следующий шаг
...
# Вывод: Гипотеза не подтвердилась, переменнная содержит корректное значение
...
# Код для проверки: Попробовать круглые или квадратные скобки ()...[]
# Установленный факт: Нужно указывать перменные в фигурных скобках {}
# Вывод: Гипотеза не подтвердилась

# Гипотеза 8: Неоходимо передаеть в качестве аргумента - ключевое слово
# Способ проверки: Прочитать документацию по .format() - еще разок
# Код для проверки: Попробовать передать аргументы в качестве ключевого слова
